...
question5b<-function(){
   ...
   ggplot1 <- ggplot(data = d, mapping = aes(x =  availability_90, y = pricelast, col = review_scores_averages)) + geom_point() + geom_smooth( method = "lm") + labs(x = "Availability over last quarter", y = "Last known price of rent for property" ) + ylim(3, 999)
  
    
 
  
  print(ggplot(data = d, mapping = aes(x =  availability_90, y = pricelast, col = review_scores_averages)) + geom_point() + geom_smooth( method = "lm") + labs(x = "Availability over last quarter", y = "Last known price of rent for property" ) + ylim(3, 999)) 
