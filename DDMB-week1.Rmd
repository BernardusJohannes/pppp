...
question5c<-function(){
    ...
    ggplot1 <- ggplot(data = d, mapping = aes(x = pricelast <= 999, y = availability_90, col = review_scores_averages)) + geom_point() + geom_smooth( method = "lm") + labs(x = "Last known price of rent for property", y = "Availability over last quarter" )
  
  print(ggplot(data = d, mapping = aes(x = pricelast, y = availability_90, col = review_scores_averages)) + geom_point() + geom_smooth( method = "lm") + labs(x = "Last known price of rent for property", y = "Availability over last quarter" ))
