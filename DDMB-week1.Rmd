...
question5a<-function(){
  ...
  d$review_scores_averages <- (d$review_scores_accuracy + d$review_scores_cleanliness + d$review_scores_communication + d$review_scores_location     + d$review_scores_rating +       d$review_scores_value) / 6

  d$review_scores_averages <- ifelse(d$review_scores_averages <= 4.94, "lower", "higher")
  d$review_scores_averages[is.na(d$review_scores_averages)] <- 0
  ...
  d$review_scores_averages <<- d$review_scores_averages
